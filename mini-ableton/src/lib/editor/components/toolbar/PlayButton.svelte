...
<button on:pointerdown={handleClick} class="p-1.5 second-bg-color rounded-lg">
  {#if $player.playing }
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" class="icon-fill-active w-4 h-4">
