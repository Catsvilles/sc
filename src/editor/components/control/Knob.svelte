<script lang="ts">
  ...
  import {volume, pan} from "@app/stores/effects";
...
>
  ...
  >
    <!-- Background -->
    <circle opacity="0.1" cx="50%" cy="50%" r={size / 2} fill="#cccccc" />
    ...
    >
      ...
      <g transform={`translate(${size / 2} ${size / 2}) rotate(${normalized * 270 - 135})`}>
        <line
