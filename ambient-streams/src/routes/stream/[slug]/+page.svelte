<script lang="ts">
    ...
    $: favorite = $cachedFavorites[clip.id];
...
<Page colors={backgroundColor} class="flex flex-col items-center justify-start gap-10">
    <div class="fixed top-0 z-20 flex flex-row items-center justify-between p-4 w-full">
        ...
        <button on:pointerdown={()=>{leftPanelOpened = !leftPanelOpened}}>
            <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 stroke-[url(#gradient)]" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
    ...
    <div bind:this={card} class="flex items-center justify-center w-full h-[40%] bg-cover bg-center opacity-75" style="background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0), rgba(0, 0, 0, 0), var(--background-color)), url('{clip.thumbnail}')">
        <span class="text-xl">{clip.title}</span>
    </div>
    <div>
        <div class="flex flex-row gap-2 rounded-md bg-[var(--navbar-color)] -mt-20 z-10 opacity-75">
    ...
    <div class="flex flex-row items-center justify-center gap-10 pb-15">
        ...
        <button on:pointerdown={togglePlayback}>
            {#if isPlaying}
                <svg xmlns="http://www.w3.org/2000/svg" class="w-14 h-14 stroke-[url(#gradient)]" viewBox="0 0 24 24" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                    <path d="M6 5m0 1a1 1 0 0 1 1 -1h2a1 1 0 0 1 1 1v12a1 1 0 0 1 -1 1h-2a1 1 0 0 1 -1 -1z" />
                    <path d="M14 5m0 1a1 1 0 0 1 1 -1h2a1 1 0 0 1 1 1v12a1 1 0 0 1 -1 1h-2a1 1 0 0 1 -1 -1z" />
                </svg>
            {:else}
                <svg xmlns="http://www.w3.org/2000/svg" class="w-14 h-14 stroke-[url(#gradient)]" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
        ...
        <button on:pointerdown={()=>{toggleFavorites(clip)}}>
            {#if favorite}
                <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 stroke-[url(#gradient)]" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
